    ...
    <>
      <div className="sticky top-0 border-b-2 border-[#bd93f9] z-10">
        <nav className="bg-[#282a36] border-gray-200 px-2 sm:px-4 py-2.5 dark:bg-[#282a36]">
          <div className="container flex flex-wrap mx-auto justify-between">
            <a href="#" className="flex items-center">
                <img src="/logo.svg" alt="LexCode" className="pl-3 h-8" />
            </a>
            <button className="inline-flex justify-items-center p-2 ml-3 text-sm text-gray-500 rounded-lg md:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-200 dark:hover:bg-gray-800 dark:focus:ring-[#50fa7b]" 
